7\\Ì–ÉÖ¤û3î|çpsÅë=‡µñ\"n	{ä5©úíL®<ÅX³èy¼<U’;œœ›÷`}ÁCC,”¹-¶‹PÁĞ8\r,‡¿pş–óY{íâŞz*+:3j¬¨ïlĞ¯>[Œ ´®\nÿORÎNÿÌ-\0ö`Ë€¿#xå«bë\nro`;Odöõ\0¯~ø)&lOóÃûÁ0ò;­€M…ïŠ úü#(&Ì&­0úàÎºÏú‚…şäN\0ïCL€ÓÍP>ò§»	ˆ¾ŠÄòŠŠäó\nhÂÏhŞÏ­Œ„\0");}elseif($_GET["file"]=="functions.js"){header("Content-Type: text/javascript; charset=utf-8");echo
...
DateTime($X);$ab='MongoDB\BSON\UTCDatetime';$X=new$ab($wb->getTimestamp()*1000);$ne=$A[1];}switch($ne){case'=':$ne='$eq';break;case'!=':$ne='$ne';break;case'>':$ne='$gt';break;case'<':$ne='$lt';break;case'>=':$ne='$gte';break;case'<=':$ne='$lte';break;case'regex':$ne='$regex';break;default:continue;}if($U=='and')$vb['$and'][]=array($db=>array($ne=>$X));elseif($U=='or')$vb['$or'][]=array($db=>array($ne=>$X));}}}return$vb;}$pe=array("=","!=",">","<",">=","<=","regex","(f)=","(f)!=","(f)>","(f)<","(f)>=","(f)<=","(date)=","(date)!=","(date)>","(date)<","(date)>=","(date)<=",);}function
...
false;}function
convert_field($p){}function
unconvert_field($p,$J){if(in_array($p['type'],["Int8","Int16","Int32","Int64","UInt8","UInt16","UInt32","UInt64","Float32","Float64"]))return"to$p[type]($J)";return$J;}function
...
qsl('div').onclick = whisperClick;",""));if(like_bool($p))return'<input type="checkbox" value="'.h($Y?$Y:1).'"'.(preg_match('~^(1|t|true|y|yes|on)$~i',$Y)?' checked':'')."$Da>";$Qc="";if(preg_match('~time~',$p["type"]))$Qc=lang(57);if(preg_match('~date|timestamp~',$p["type"]))$Qc=lang(58).($Qc?" [$Qc]":"");if($Qc)return"<input value='".h($Y)."'$Da> ($Qc)";if(preg_match('~_(md5|sha1)$~i',$p["field"]))return"<input type='password' value='".h($Y)."'$Da>";return'';}function
...
';if($Wd=="auth"){$pc=true;foreach((array)$_SESSION["pwds"]as$Qg=>$_f){foreach($_f[""]as$V=>$F){if($F!==null){if($pc){echo"<p id='logins'>",script("mixin(qs('#logins'), {onmouseover: menuOver, onmouseout: menuOut});");$pc=false;}echo"<a href='".h(auth_url($Qg,"",$V))."'>".($V!=""?h($V):"<i>".lang(7)."</i>")."</a><br>\n";}}}}else{$this->databasesPrint($Wd);if($Wd!="db"&&$Wd!="ns"){$S=table_status('',true);if(!$S)echo"<p class='message'>".lang(9)."\n";else$this->tablesPrint($S);}}}function
